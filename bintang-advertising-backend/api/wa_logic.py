...
def get_system_prompt(nama_pelanggan=""):
    ...
    petunjuk_data = (
        ...
        "- Pelanggan tanya produk/jasa apa saja atau sebut nama produk tertentu -> panggil "
        "cari_produk. Pelanggan tanya harga (dgn atau tanpa ukuran/qty jelas) -> cari_produk lalu "
        "hitung_harga_produk. JANGAN PERNAH sebut angka harga tanpa lewat hitung_harga_produk.\n"
