...
export default function RincianMutasiAkunTable({
  loading,
  filteredRows,
  saldoAwal,
  formatIDR,
          ...
          <table className="w-full text-left text-xs border-collapse">
            <thead className="bg-[#F8FAFC] text-slate-450 font-bold border-b border-slate-100">
              <tr>
                ...
                <th className="px-5 py-3">Dilayani Oleh</th>
                    ...
                    <td className="no-print px-5 py-3 text-center relative">
                      ...
                      {activeActionRowId === idx && (
                        ...
                        >
                          <button
                            type="button"
                            onClick={() => onOpenPasangan(row.entry_number)}
                          ...
                          <button
                            type="button"
                            onClick={() => onOpenHapus(row.entry_number)}
