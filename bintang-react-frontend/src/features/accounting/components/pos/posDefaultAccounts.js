export const POS_ACCOUNT_FIELDS = [
  ...
  { key: 'pos_sales_delivery_account', label: 'Pengiriman Penjualan', required: true },
  { key: 'pos_sales_rounding_account', label: 'Pembulatan penjualan', required: true },
  { key: 'pos_sales_unique_payment_account', label: 'Pembayaran unik penjualan', required: true },
];
