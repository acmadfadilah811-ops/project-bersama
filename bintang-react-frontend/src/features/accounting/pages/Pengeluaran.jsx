...
import TipeTransaksiPengeluaranModal from '../components/pos/TipeTransaksiPengeluaranModal';
...
export default function Pengeluaran() {
  ...
  const [rows, setRows] = useState([
    { id: 1, date: '16-Jul-2026', txNo: 'E-OL260716000001 (16-Jul-2026)', type: 'Oh | Ohj', user: 'Brandy', amount: 568965, debitAcc: '', creditAcc: '11101 Kas', status: 'Belum Terposting' }
  ]);
  ...
  const handlePost = () => {
    ...
    notify({
      ...
      message: 'Transaksi pengeluaran terpilih berhasil diposting.'
    });
  };
  ...
  const handleCancelPost = () => {
    ...
    notify({
      type: 'success',
      title: 'Batal Posting',
      message: 'Posting transaksi pengeluaran terpilih berhasil dibatalkan.'
    });
  };
  ...
  return (
    <div className="space-y-4 animate-fade-in text-xs font-semibold text-slate-700">
      ...
      <div className="bg-amber-50 border border-amber-200 rounded-lg p-3.5 flex items-start gap-3 shadow-2xs">
        ...
        <div className="space-y-1">
          <p className="font-bold text-amber-900 text-xs">
            Sistem Belum Terhubung ke POS Pengeluaran
          </p>
          <p className="text-amber-700 text-[11px] font-medium leading-relaxed">
            Penyelarasan jurnal pengeluaran kasir POS belum aktif secara terpadu. 
      ...
      <div className="flex items-center justify-between">
        <h2 className="text-base font-bold text-slate-900">Data Pengeluaran</h2>
